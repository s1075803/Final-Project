...
```{r}
plot(model.icm.ny, y = "si.flow", lwd = 4, col = "firebrick", main = "Disease Incidence", legend="n", xlab="Time", ylab="Number of Citizens")
```
...
# Problem 6: Government i=Intervention
...
```{r}
summary(model.ny.intervention, at=499.5)
```
