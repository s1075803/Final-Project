...
=======
param.ny <- param.dcm(inf.prob = 0.7, act.rate=2.2, rec.rate=1/14, a.rate = 0.014,ds.rate=0,di.rate=0.2,dr.rate = 0)
>>>>>>> 2d76c86752978cfe954dd24455dac4d04b2ea0d2
...
```{r}
param.icm.ny <- param.icm(inf.prob = 0.7,rec.rate=1/14)
init.icm.ny <- init.icm(s.num = 100000, i.num = 1, r.num = 0)
control.icm.ny <- control.icm(type="SIR", nsims = 10,nsteps = 300)
...
## ICM Model Stochasticity NYC

```{r}
param.icm.ny <- param.icm(inf.prob = 0.7, act.rate = 2.2, rec.rate = 1/14, di.rate = 0.2, a.rate = 0.014, dr.rate = 0, ds.rate = 0)
init.icm.ny <- init.icm(s.num = 8399000, i.num = 1, r.num = 0)
control.icm.ny <- control.icm(type="SIR", nsims = 10, nsteps = 500)
model.icm.ny <- icm(param.icm.ny,init.icm.ny, control.icm.ny)
model.icm.ny
```
